...
const agregarApodo = (persona, apodo) => {
    return {
        ...persona,
        apodo: apodo
    };
...
const sinDocumento = function(persona) {
 ...
 */
// Usando arrow function
const nombreCompletoDePersona = (persona) => {
 ...
 */
// Usando expresión de función
const felizCumpleaños = function(persona) {
    return {
        ...persona,
        edad: persona.edad + 1
    };
 ...
 */
// Usando arrow function
const personaMasGrande = (persona1, persona2) => {
